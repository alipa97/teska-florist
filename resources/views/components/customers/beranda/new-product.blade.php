<section class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
  <h2 class="text-3xl font-semibold text-center text-gray-800 mb-8">Produk Baru</h2>
      ...
      <div class="p-4">
        ...
        <div class="mt-4">
          ...
          <a 
            ...
            class="block text-center text-white bg-pink-500 hover:bg-pink-600 px-4 py-2 rounded mb-2"
          >
            Beli Sekarang
          </a>
  ...
  <div class="flex justify-center mt-8">
    <a 
      ...
      class="text-pink-500 hover:text-pink-700 font-semibold text-lg"
    >
      Lihat Semua Produk
    </a>
  </div>
