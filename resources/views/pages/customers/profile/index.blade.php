            ...
            <form action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    ...
                    <div class="flex justify-end sm:col-span-6">
                        <button type="submit" class="px-4 py-2 text-sm font-semibold text-white shadow-sm bg-pink-500 hover:bg-pink-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-950">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
